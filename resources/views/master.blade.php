				...
				<div class="header-area">
					...
					<div class="header-right">
						<form action="/search" method="get">
							<input type="text" id="searchBar" placeholder="Search "style="width: 2000px;" name="search_v" />
			...
			<div class="login-box">
				...
				<form action="#">
					...
					<div class="login-signup">
						<a href="#" class="theme-danger">Sign Up</a>
					</div>
...
<br><br>
								...
								<button class="theme-btn" style="width: 250px;">SUBSCRIBE NOW</button>
							</form>
						</div>
                    </div>
				</div>
